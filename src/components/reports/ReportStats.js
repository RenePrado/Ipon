  ...
  return (
    <div className="grid grid-cols-4 gap-3 mb-5">
      <div className="bg-bg-elevated dark:bg-dark-bg-elevated rounded-lg p-4 border border-border dark:border-dark-border">
        ...
        <div className="font-mono text-lg font-semibold text-success">{fmt(income)}</div>
      </div>
      <div className="bg-bg-elevated dark:bg-dark-bg-elevated rounded-lg p-4 border border-border dark:border-dark-border">
      ...
      <div className="bg-bg-elevated dark:bg-dark-bg-elevated rounded-lg p-4 border border-border dark:border-dark-border">
        ...
        <div className={`font-mono text-lg font-semibold ${income - expense >= 0 ? 'text-success' : 'text-danger'}`}>{fmtSigned(income - expense)}</div>
      </div>
      <div className="bg-bg-elevated dark:bg-dark-bg-elevated rounded-lg p-4 border border-border dark:border-dark-border">
        <div className="text-text-tertiary dark:text-dark-text-tertiary text-xs mb-1">Transactions</div>
        <div className="font-mono text-lg font-semibold text-text-primary dark:text-dark-text-primary">{transactionCount}</div>
      </div>
    </div>
  );
}
