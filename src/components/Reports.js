      ...
      <div className="flex flex-col sm:flex-row gap-3 sm:gap-3 mb-4 sm:mb-6 items-start sm:items-center">
        {viewMode === 'monthly' ? (
          <div className="grid grid-cols-3 sm:flex sm:flex-row gap-1.5 sm:gap-2 w-full sm:w-auto items-center">
            <button
              className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium h-8 sm:h-9 flex items-center justify-center transition-colors duration-300 ${viewMode === 'monthly'
            ...
            <button
              className={`px-2 sm:px-4 py-1.5 sm:py-2 rounded-md text-xs sm:text-sm font-medium h-8 sm:h-9 flex items-center justify-center transition-colors duration-300 ${viewMode === 'custom'
                  ? 'bg-accent-primary hover:bg-accent-primary/90 text-white border border-transparent'
                  : 'bg-bg-elevated dark:bg-dark-bg-elevated text-text-primary dark:text-dark-text-primary border border-border dark:border-dark-border hover:bg-bg-elevated-2 dark:hover:bg-dark-bg-elevated-2'
                }`}
          ...
          <>
            <div className="flex gap-2 items-center w-full sm:w-auto">
              <button
                className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-md text-xs sm:text-sm font-medium h-8 sm:h-9 flex items-center justify-center transition-colors duration-300 ${viewMode === 'monthly'
                    ? 'bg-accent-primary hover:bg-accent-primary/90 text-white border border-transparent'
                    : 'bg-bg-elevated dark:bg-dark-bg-elevated text-text-primary dark:text-dark-text-primary border border-border dark:border-dark-border hover:bg-bg-elevated-2 dark:hover:bg-dark-bg-elevated-2'
                  }`}
                onClick={() => setViewMode('monthly')}
              ...
              <button
                className={`px-3 py-1.5 sm:px-4 sm:py-2 rounded-md text-xs sm:text-sm font-medium h-8 sm:h-9 flex items-center justify-center transition-colors duration-300 ${viewMode === 'custom'
                    ? 'bg-accent-primary hover:bg-accent-primary/90 text-white border border-transparent'
                    : 'bg-bg-elevated dark:bg-dark-bg-elevated text-text-primary dark:text-dark-text-primary border border-border dark:border-dark-border hover:bg-bg-elevated-2 dark:hover:bg-dark-bg-elevated-2'
                  }`}
                onClick={() => setViewMode('custom')}
